          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6 text-left">
                Vår skidskola erbjuder omfattande undervisning för alla skidnivåer i den fantastiska miljön i Hemavan. Oavsett om du tar dina första steg på skidor eller vill förfina avancerade tekniker, ger våra instruktörer personlig vägledning i små grupper.<br /> 
