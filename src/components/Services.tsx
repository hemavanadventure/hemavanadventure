  ...
  const services = [
    {
      ...
      icon: Mountain,
      link: language === 'sv' ? '/topptur-privatguide' : '/en/topptur-privatguide',
    ...
    },
    {
      ...
      price: t('services.price6000'),
      icon: Users,
      link: language === 'sv' ? '/off-pist-guiding' : '/en/off-pist-guiding',
    ...
    },
    {
      ...
      icon: Compass,
      link: language === 'sv' ? '/topptur-helgeland' : '/en/topptur-helgeland',
