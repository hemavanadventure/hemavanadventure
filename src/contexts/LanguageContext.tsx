...
const translations = {
  ...
  se: {
    ...
    'about.discoverDesc1': 'Beläget i hjärtat av den Skandinaviska fjällkedjan erbjuder Hemavan ett av Europas mest mångsidiga topptursområden. Från snälla sluttningar perfekta för nybörjare till utmanande toppar för de mera erfarna, vi har äventyr för alla färdighetsnivåer.',
